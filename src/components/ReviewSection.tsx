...
const ReviewSection: React.FC<ReviewSectionProps> = ({ activity }) => {
  ...
  return (
    <section className="bg-sand-light dark:bg-gray-900 py-12">
      <div className="container">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-2xl font-medium text-gray-900 dark:text-white">Reviews</h2>
          
          <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="md:col-span-1">
              <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 animate-fade-up" style={{ animationDelay: "0.3s" }}>
                <div className="text-center">
                  <div className="flex items-center justify-center gap-1">
                    <span className="text-4xl font-medium text-gray-900 dark:text-white">{activity.rating.toFixed(1)}</span>
            ...
            <div className="md:col-span-2">
              <div className="space-y-6">
                {activity.reviews.map((review) => (
                  <div 
                    key={review.id} 
                    className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm animate-fade-up"
